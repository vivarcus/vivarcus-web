...
export type DomainSettingsPageChrome = {
  ...
  cancel_label: DisplayText;
  name_label: DisplayText;
  actions_column: DisplayText;
  cidr_label: DisplayText;
  cidr_ip_label: DisplayText;
  action_label: DisplayText;
  priority_label: DisplayText;
  allow_label: DisplayText;
  deny_label: DisplayText;
  key_label: DisplayText;
  profile_key_label: DisplayText;
  idp_entity_id_label: DisplayText;
  sp_entity_id_label: DisplayText;
  idp_metadata_url_label: DisplayText;
  idp_metadata_xml_label: DisplayText;
  private_key_label: DisplayText;
  esignature_profile_label: DisplayText;
  new_secret_placeholder: DisplayText;
  username_label: DisplayText;
  subject_id_label: DisplayText;
  bind_federated_id_label: DisplayText;
  bind_federated_help: DisplayText;
  provider_label: DisplayText;
  status_label: DisplayText;
  authentication_type_label: DisplayText;
  details_section: DisplayText;
  description_label: DisplayText;
  status_active: DisplayText;
  status_inactive: DisplayText;
  auth_password: DisplayText;
  auth_sso: DisplayText;
  auth_cross_domain: DisplayText;
  new_profile_title: DisplayText;
  profile_fallback_title: DisplayText;
  delete_oauth_confirm: DisplayText;
  provider_type_label: DisplayText;
  client_credentials_section: DisplayText;
  client_id_label: DisplayText;
  client_secret_label: DisplayText;
  endpoints_section: DisplayText;
  authorization_endpoint_label: DisplayText;
  token_endpoint_label: DisplayText;
  userinfo_endpoint_label: DisplayText;
  jwks_uri_label: DisplayText;
  login_settings_section: DisplayText;
  scopes_label: DisplayText;
  login_button_label_field: DisplayText;
  enable_auth_label: DisplayText;
  redirect_uri_label: DisplayText;
  pkce_required_label: DisplayText;
  file_import_section: DisplayText;
  enable_file_import_label: DisplayText;
  file_import_scopes_label: DisplayText;
  federated_identity_section: DisplayText;
  all_profiles: DisplayText;
  active_profiles: DisplayText;
  inactive_profiles: DisplayText;
  provider_feishu: DisplayText;
  new_policy_title: DisplayText;
  policy_fallback_title: DisplayText;
  delete_policy_confirm: DisplayText;
  policy_key_label: DisplayText;
  policy_name_label: DisplayText;
  security_settings_section: DisplayText;
  password_requirements_label: DisplayText;
  password_require_digit: DisplayText;
  password_require_upper: DisplayText;
  password_require_lower: DisplayText;
  password_require_special: DisplayText;
  min_password_length_label: DisplayText;
  password_expiration_label: DisplayText;
  password_history_label: DisplayText;
  password_reset_limit_label: DisplayText;
  lockout_threshold_label: DisplayText;
  lockout_duration_label: DisplayText;
  require_security_question: DisplayText;
  allow_browser_password_save: DisplayText;
  saml_profile_label: DisplayText;
  oauth_oidc_profile_label: DisplayText;
  api_token_expiry_label: DisplayText;
  session_idle_label: DisplayText;
  session_max_lifetime_label: DisplayText;
  session_max_lifetime_help: DisplayText;
  hours_suffix: DisplayText;
  mfa_section: DisplayText;
  mfa_required: DisplayText;
  mfa_methods_label: DisplayText;
  mfa_totp: DisplayText;
  mfa_webauthn: DisplayText;
  mfa_sms: DisplayText;
  delegated_auth_section: DisplayText;
  delegate_allowed: DisplayText;
  delegate_max_days_label: DisplayText;
  compliance_section: DisplayText;
  compliance_text_label: DisplayText;
  compliance_version_label: DisplayText;
  all_policies: DisplayText;
  active_policies: DisplayText;
  inactive_policies: DisplayText;
  session_idle_domain_default: DisplayText;
  duration_minutes: DisplayText;
  duration_hours: DisplayText;
  duration_hour_one: DisplayText;
  never_label: DisplayText;
  expires_in_days: DisplayText;
  password_history_none: DisplayText;
  password_history_reuse: DisplayText;
  password_history_reuse_one: DisplayText;
  per_day: DisplayText;
  unlimited_label: DisplayText;
  permanent_label: DisplayText;
};
